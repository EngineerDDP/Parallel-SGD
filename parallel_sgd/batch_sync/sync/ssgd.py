...
from parallel_sgd.codec.interfaces import Codec, netEncapsulation, T
from constants import SSGD_Sync_Timeout_Limit_MSec
from parallel_sgd.batch_sync.sync.interface import ISyncType
from parallel_sgd.batch_sync.sync.interface import ReadTimeOut, AsyncDetected
...
class SynchronizedSGD(ISyncType):
    """
